...
ETAPA 7 — Revisão da spec v3 (skill: spec-reviewer)
    ↓ spec v3 aprovada → pronta para o Claude Code
```
...
- O que fazer a seguir: abrir o VS Code e usar o agente `orquestrador` no Claude Code
