...
- `.claude/skills/tarefas-design/README.md` — fundamentos visuais, voz e tom
- `.claude/skills/tarefas-design/tokens/colors.css` — paleta de cores
- `.claude/skills/tarefas-design/tokens/typography.css` — tipografia
- `.claude/skills/tarefas-design/tokens/spacing.css` — espaçamento e dimensões
- `.claude/skills/tarefas-design/tokens/effects.css` — radius, sombras, animações
- `.claude/skills/tarefas-design/components/` — componentes disponíveis
- `.claude/skills/tarefas-design/ui_kits/tarefas/` — telas completas do app como referência
