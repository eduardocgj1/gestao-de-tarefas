---
name: task-planner
description: Lê o discovery técnico (spec v3) de uma feature e decompõe em tasks atômicas e ordenadas, prontas para o Claude Code implementar. Usar após o v3 estar completo e antes de iniciar o desenvolvimento.
---
...
## Antes de começar
Leia:
- `CLAUDE.md` — convenções e stack do projeto
...
Ao final das tasks, liste de 3 a 7 critérios objetivos e comportamentais — o que o usuário consegue fazer quando a feature estiver pronta. Esses critérios serão usados pelo agente `spec-checker` no Claude Code para validar a implementação.
